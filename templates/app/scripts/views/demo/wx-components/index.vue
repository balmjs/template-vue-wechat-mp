  ...
  <div v-if="show" class="cnt">
      ...
      <div class="comp-cnt wx-movable-cnt">
        <wx-movable-area class="wx-movable-area">
          ...
          <template v-if="wxMovableView.addDirection">
            ...
            <wx-movable-view
              ...
              class="wx-movable-view"
              @change="
                log('[wx-movable-view horizontal change]', $event.detail)
              "
              @htouchmove="
                log('[wx-movable-view horizontal htouchmove]', $event)
              "
              @vtouchmove="
                log('[wx-movable-view horizontal vtouchmove]', $event)
              "
              >h</wx-movable-view
            >
            <wx-movable-view
        ...
        <div class="opr-cnt">
          ...
          <wx-button
            ...
            >增加四个不同方向滑块</wx-button
          >
          <wx-button
            class="wx-button opr-button add-view"
            @click="wxMovableView.addDirection = false"
            >删除四个不同方向滑块</wx-button
          >
        </div>
        <div class="opr-cnt">
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt wx-scroll-view-cnt">
        <wx-scroll-view
          ...
          @refresherrestore="
            log('[wx-scroll-view refresherrestore]', $event.detail)
          "
          @refresherabort="
            log('[wx-scroll-view refresherabort]', $event.detail)
          "
        >
          <div class="inner2-y">
        ...
        <div class="opr-cnt opr-cnt-y">
          ...
          <wx-button
            ...
            >滚动到 120px 处</wx-button
          >
          <wx-button
            class="wx-button opr-button"
            @click="
              setAttribute('wx-scroll-view-y', 'refresher-triggered', true)
            "
            >触发下拉</wx-button
          >
        </div>
        <div class="opr-cnt opr-cnt-y">
          ...
          <wx-switch
            :checked="true"
            @change="
              wxScrollView.y.scrollWithAnimation =
        ...
        <wx-scroll-view
          ...
          @scroll="
            ...
            log('[wx-scroll-view scroll]', $event.detail);
          "
          @scrolltoupper="log('[wx-scroll-view scrolltoupper]', $event.detail)"
          @scrolltolower="log('[wx-scroll-view scrolltolower]', $event.detail)"
        >
        ...
        <div class="opr-cnt">
          ...
          <wx-switch
            :checked="true"
            @change="
              wxScrollView.x.scrollWithAnimation =
                $event.detail.value.toString()
            "
          ></wx-switch>
        </div>
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        ...
        <wx-button class="wx-button" @click="onUpdateView"
          >更新 hover 颜色</wx-button
        >
      </div>
    </wx-view>
    <wx-view class="item">
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-progress
          ref="wx-progress-update"
          class="wx-progress"
          :percent="wxProgress.percent1"
          :show-info="true"
          stroke-width="3"
          @activeend="log('[wx-progress]', $event.detail)"
        ></wx-progress>
        <wx-progress
          ref="wx-progress-update"
          class="wx-progress"
          :percent="wxProgress.percent2"
          :active="true"
          stroke-width="6"
          @activeend="log('[wx-progress]', $event.detail)"
        ></wx-progress>
        ...
        <wx-progress
          ...
          @activeend="log('[wx-progress]', $event.detail)"
        ></wx-progress>
        <wx-button class="wx-button" @click="onUpdateWxProgress"
          >更新进度</wx-button
        >
      </div>
    </wx-view>
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-rich-text
          class="wx-rich-text"
          space="emsp"
          :nodes="wxRichText.nodes1"
        ></wx-rich-text>
        <wx-rich-text
          class="wx-rich-text"
          :nodes="wxRichText.nodes2"
        ></wx-rich-text>
      </div>
    </wx-view>
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        ...
        <div>
          <wx-text ref="wx-text1" :user-select="true" :decode="true"></wx-text>
        </div>
        <div ref="wx-text2"></div>
        <wx-button class="wx-button" @click="onUpdateWxText"
          >更新内容</wx-button
        >
      </div>
    </wx-view>
    <wx-view class="item">
      ...
      <div class="comp-cnt wx-button-cnt">
        <wx-button
          class="wx-button"
          type="primary"
          @tap="log('[wx-button] tap', $event)"
          @longpress="log('[wx-button] longpress', $event)"
          >页面主操作 Normal</wx-button
        >
        <wx-button
          class="wx-button"
          type="primary"
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        ...
        <div>
          <wx-checkbox :disabled="true"></wx-checkbox><span>禁用 1</span>
        </div>
        <div>
          <wx-checkbox :checked="true" :disabled="true"></wx-checkbox
          ><span>禁用 2</span>
        </div>
        <div>
          <wx-checkbox :checked="true" color="#FF0000"></wx-checkbox
          ><span>颜色 - 红</span>
        </div>
        <wx-checkbox-group
          class="wx-checkbox-group"
          @change="log('[wx-checkbox] change', $event.detail)"
        >
          <div>
            <wx-checkbox :checked="true" value="中"></wx-checkbox
            ><span>中国</span>
          </div>
          <div>
            <wx-checkbox :checked="true" value="俄"></wx-checkbox
            ><span>俄罗斯</span>
          </div>
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-form
          @submit="log('[wx-form] submit', $event.detail)"
          @reset="
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-input
          class="wx-input"
          value="默认 value 值"
          @input="log('[wx-input] input', $event.detail)"
          @focus="log('[wx-input] focus', $event.detail)"
          @blur="log('[wx-input] blur', $event.detail)"
          @confirm="log('[wx-input] confirm', $event.detail)"
        />
        <wx-input
          class="wx-input"
          placeholder="文本输入框"
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-checkbox-group
          @change="log('[wx-label] checkbox change', $event.detail)"
        >
          <div>表单组件在 wx-label 内</div>
          <div>
            <wx-label
              ><wx-checkbox :checked="true" value="中国"></wx-checkbox
              >中国</wx-label
            >
          </div>
          <div>
            <wx-label><wx-checkbox value="美国"></wx-checkbox>美国</wx-label>
          </div>
        </wx-checkbox-group>
        <wx-radio-group @change="log('[wx-label] radio change', $event.detail)">
          <div>wx-label 用 for 标识表单组件</div>
          <div>
            <wx-radio id="label-radio-1" :checked="true" value="中国"></wx-radio
            ><wx-label for="label-radio-1">中国</wx-label>
          </div>
          <div>
            <wx-radio id="label-radio-2" value="美国"></wx-radio
            ><wx-label for="label-radio-2">美国</wx-label>
          </div>
        </wx-radio-group>
        <wx-checkbox-group
          @change="log('[wx-label] checkbox change', $event.detail)"
        ...
        <div class="add-margin-top">
          <wx-label
            ><wx-switch
              @change="log('[wx-label] switch change', $event.detail)"
            ></wx-switch
            >wx-switch</wx-label
          >
        </div>
        ...
        <div class="add-margin-top">
          <wx-label
            ><wx-button class="wx-button" @tap="log('[wx-label] button tap')"
              >按钮</wx-button
            >wx-button</wx-label
          >
        </div>
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-picker
          ...
          @cancel="log('[wx-picker] cancel', $event)"
        >
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        ...
        <div>
          <wx-radio :checked="true" :disabled="true"></wx-radio
          ><span>禁用 2</span>
        </div>
        <div>
          <wx-radio :checked="true" color="#FF0000"></wx-radio
          ><span>颜色 - 红</span>
        </div>
        <wx-radio-group
          class="wx-radio-group"
          @change="log('[wx-radio] change', $event.detail)"
        >
          <div>
            <wx-radio :checked="true" value="中"></wx-radio><span>中国</span>
          </div>
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt wx-picker-view-cnt">
        <wx-picker-view
          ...
          @change="log('[wx-picker-view] change', $event.detail)"
          @pickstart="log('[wx-picker-view] pickstart', $event)"
          @pickend="log('[wx-picker-view] pickend', $event)"
        >
          <wx-picker-view-column class="wx-picker-view-column">
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-slider
          class="wx-slider"
          @change="log('[wx-slider] change', $event.detail)"
          @changing="log('[wx-slider] changing', $event.detail)"
        ></wx-slider>
        <wx-slider
          class="wx-slider"
          min="1"
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-switch
          class="wx-switch"
          :checked="true"
          @change="log('[wx-switch]', $event.detail)"
        ></wx-switch>
        <wx-switch
          class="wx-switch"
          :checked="true"
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-textarea
          class="wx-textarea"
          value="默认 value 值"
          @input="log('[wx-textarea] input', $event.detail)"
          @focus="log('[wx-textarea] focus', $event.detail)"
          @blur="log('[wx-textarea] blur', $event.detail)"
          @confirm="log('[wx-textarea] confirm', $event.detail)"
          @linechange="log('[wx-textarea] linechange', $event.detail)"
        />
        <wx-textarea
          class="wx-textarea"
          placeholder="占位文本样式1"
        ...
        <wx-button
          ...
          >修改上面 textarea 的 maxlength</wx-button
        >
        <wx-textarea
          class="wx-textarea"
        ...
        <wx-button
          class="wx-button"
          type="default"
          @tap="wxTextarea.focus = true"
          >聚焦上面 textarea</wx-button
        >
        <wx-textarea
          class="wx-textarea"
          placeholder="自动增高"
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <div>
          缩放模式，不保持纵横比缩放图片，使图片的宽高完全拉伸至填满 wx-image
          元素
        </div>
        <wx-image
          class="wx-image"
          ...
          @load="log('[wx-image] load', $event.detail)"
          @error="log('[wx-image] error', $event.detail)"
        ></wx-image>
        <div>
        ...
        <wx-image
          class="wx-image"
          style="width: 200px; height: 200px; background-color: #eee"
          src="https://june.haha/123456.jpg"
          @load="log('[wx-image] load', $event.detail)"
          @error="log('[wx-image] error', $event.detail)"
        ></wx-image>
        <div>lazy-load</div>
        <wx-image
          ...
          :lazy-load="true"
          src="https://res.wx.qq.com/wxdoc/dist/assets/img/0.4cb08bb4.jpg"
          @load="log('[wx-image] lazy-load load', $event.detail)"
          @error="log('[wx-image] lazy-load error', $event.detail)"
        ></wx-image>
      </div>
    </wx-view>
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        ...
        <div class="opr-cnt">
          ...
          <wx-switch
            @change="wxCanvas.disableScroll = $event.detail.value.toString()"
          ></wx-switch>
        </div>
        <div>2d Canvas 动画</div>
        <wx-canvas
          ref="wx-canvas-animation"
          class="wx-canvas-2"
          type="2d"
        ></wx-canvas>
        <wx-canvas
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <div
          @touchstart="log('root touchstart')"
          @touchend="log('root touchend')"
          @click="log('root click')"
        >
          <div>
            touchstart -> root touchstart -> touchend -> root touchend -> click
            -> root click
          </div>
          <wx-button
            class="wx-button"
            ...
            @click="log('click')"
            >normal event</wx-button
          >
          <div>
            parent touchstart -> touchstart -> root touchstart -> parent
            touchend -> touchend -> root touchend -> parent click -> click ->
            root click
          </div>
          <wx-capture
            @touchstart="log('parent touchstart')"
            @touchend="log('parent touchend')"
            @click="log('parent click')"
          >
            <wx-button
              class="wx-button"
              @touchstart="log('touchstart')"
              @touchend="log('touchend')"
              @click="
                wxCapture.eventCount++;
                log('click');
              "
              >capture-inner({{ wxCapture.eventCount }})</wx-button
            >
          </wx-capture>
        </div>
      </div>
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        ...
        >
          <div>
            touchstart -> parent touchstart -> touchend -> parent touchend
          </div>
          <wx-catch
            @touchstart="log('parent touchstart')"
            @touchend="log('parent touchend')"
          ...
          >
            <wx-button
              ...
              @click="
                ...
                log('click');
              "
              >catch-inner1({{ wxCatch.eventCount }})</wx-button
            >
          </wx-catch>
          ...
          <wx-catch @click="log('parent click')">
            <wx-button
              ...
              @click="
                ...
                log('click');
              "
              >catch-inner2({{ wxCatch.eventCount }})</wx-button
            >
          </wx-catch>
      ...
      <div class="comp-cnt">
        <div class="event-cnt">
          ...
          <wx-animation
            :class="[
              'event-t',
              wxAnimation.transition ? 'event-t-s' : 'event-t-e'
            ]"
            @transitionend="log('transition end')"
          ></wx-animation>
          <wx-button
            class="wx-button"
            @click="wxAnimation.transition = !wxAnimation.transition"
            >transition</wx-button
          >
        </div>
        <div class="event-cnt">
    ...
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        ...
        <wx-button
          class="wx-button"
          type="default"
          @tap="onSetKboneAttributeMap1"
          >操作1</wx-button
        >
        <wx-button
          class="wx-button"
          type="default"
          @tap="onSetKboneAttributeMap2"
          >操作2</wx-button
        >
        <wx-button
          class="wx-button"
          type="default"
          @tap="onSetKboneAttributeMap3"
          >reset</wx-button
        >
      </div>
    </wx-view>
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-input
          placeholder="这是一个输入框"
          :kbone-event-map="kboneEventMap"
          class="wx-input"
        />
        <wx-button class="wx-button" type="default" @tap="onSetKboneEventMap1"
          >操作1</wx-button
        >
        <wx-button class="wx-button" type="default" @tap="onSetKboneEventMap2"
          >操作2</wx-button
        >
        <wx-button class="wx-button" type="default" @tap="onSetKboneEventMap3"
          >reset</wx-button
        >
      </div>
    </wx-view>
    <wx-view class="item">
      ...
      <div class="comp-cnt">
        <wx-button class="wx-button" @click="do$$getBoundingClientRect"
          >$$getBoundingClientRect</wx-button
        >
        <wx-button class="wx-button" @click="do$$getComputedStyle"
          >$$getComputedStyle</wx-button
        >
        <wx-button class="wx-button" type="primary" @click="onRemoveAll"
          >删除全部</wx-button
        >
      </div>
    </wx-view>
...
export default {
  ...
  methods: {
    ...
    onUpdateView() {
      this.wxView.hoverClass =
        this.wxView.hoverClass === 'red' ? 'green' : 'red';
    },
    onUpdateWxProgress() {
    ...
    onUpdateWxText() {
      this.$refs['wx-text2'].innerHTML =
        '<wx-text id="wx-text-decode-1" decode="true"></wx-text><wx-text id="wx-text-decode-2"></wx-text>';
      this.$nextTick(() => {
    ...
    do$$getComputedStyle(evt) {
      window
        .$$getComputedStyle(evt.target, ['backgroundColor', 'fontSize'])
        .then(console.log);
    },
    onRemoveAll() {
      this.show = false;
